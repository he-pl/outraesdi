var config = {
    ...
    footer: 'Design para um mundo em colapso - Zoy, Frederico e Cançado. PPDESDI/ UERJ',
    chapters: [
        {
            id: 'intro',
            alignment: 'left',
